...
function supportedLanguages(
  names: string[],
  flags: typeof interfaceAudioSubtitles,
): SteamGameDetail['supportedLanguages'] {
...
export const mockGameRecords: SteamGameDetail[] = [
  ...
  },
  {
    ...
    detailedDescription:
      'PUBG: BATTLEGROUNDS is a battle royale shooter where up to 100 players parachute onto a remote island and fight to be the last player or team standing. Players must locate and scavenge their own weapons, vehicles, and supplies in an ever-shrinking play area.',
    categories: [
      'Multi-player',
      'Online PvP',
      'In-App Purchases',
  ...
  },
  {
    ...
    detailedDescription:
      'Content Warning is a co-op horror comedy game where you and your friends film scary content to go viral on the internet. Dive into the eerie world beneath your quaint village, capture your friends getting absolutely terrified, and post the footage online.',
  ...
  },
  {
    ...
    detailedDescription:
      'Manor Lords is a medieval strategy game featuring deep city building, large-scale tactical battles, and complex economic and social simulations. Rule your lands as a medieval lord - grow your settlement, manage resources, and wage war.',
  ...
  },
  {
    ...
    detailedDescription:
      'Grand Theft Auto V for PC offers players the option to explore the award-winning world of Los Santos and Blaine County in resolutions up to 4k and beyond, as well as the chance to experience the game running at 60 frames per second.',
    categories: [
      'Single-player',
      'Multi-player',
      'Steam Achievements',
  ...
  },
  {
    ...
    detailedDescription:
      "Stardew Valley is an open-ended country-life RPG where you inherit your grandfather's old farm plot in Stardew Valley. You'll learn to live off the land, raise animals, build relationships with the townsfolk, and uncover the secrets of the valley.",
    categories: [
      'Single-player',
      'Multi-player',
      'Co-op',
